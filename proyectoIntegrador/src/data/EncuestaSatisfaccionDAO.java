...
public class EncuestaSatisfaccionDAO implements CRUD_Operation<EncuestaSatisfaccion, Integer> {
    ...
    public void save(EncuestaSatisfaccion encuesta) {
        String query = "INSERT INTO proyecto343.TBL_ENCUESTA_SATISFACCION (id_usuario, id_solicitud, calificacion, comentarios, fecha_respuesta) " +
                       "VALUES (?, ?, ?, ?, ?)";
    ...
    public ArrayList<EncuestaSatisfaccion> fetch() {
        ...
        String query = "SELECT * FROM proyecto343.TBL_ENCUESTA_SATISFACCION";
    ...
    public void update(EncuestaSatisfaccion encuesta) {
        String sql = "UPDATE proyecto343.TBL_ENCUESTA_SATISFACCION SET id_usuario=?, id_solicitud=?, calificacion=?, comentarios=?, fecha_respuesta=? WHERE id_encuesta=?";
    ...
    public void delete(Integer id) {
        String sql = "DELETE FROM proyecto343.TBL_ENCUESTA_SATISFACCION WHERE id_encuesta=?";
    ...
    public boolean authenticate(Integer id) {
        String sql = "SELECT id_encuesta FROM proyecto343.TBL_ENCUESTA_SATISFACCION WHERE id_encuesta=?";
