...
public class UserConnection implements DBConnection {

    private static UserConnection instance;
    private Connection connection;
    private final String username = "subusuario";
    private final String password = "usuario123";
    ...
    private UserConnection() {
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("Error connecting as user.");
        }
    }
